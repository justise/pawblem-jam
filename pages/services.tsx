                    ...
                    <div className="yui3-u-2-3">
                        <div className="grid-wrapper">
                            ...
                            <p>
                                ...
                                little TLC, fresh air and time to stretch their
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    its own neighborhood to ensure its safety
                                    and comfort
                                </li>
                                <li>Reinforced training (if applicable) </li>
                                <li>Fresh water &amp; treats</li>
                                <li>
                                    Food refill &amp; brushing (upon request)
                                </li>
                                <li>
                                ...
                                <li>
                                    We have some fabulous photographers on the
                                    team that love taking pictures of your furry
                                    family!
                                </li>
                                <li>
                                    And of course, tons of love, attention and
                                    playtime!
                                </li>
                            </ul>
                            <br />
                    ...
                    <div className="yui3-u-2-3">
                        <div className="grid-wrapper">
                            ...
                            <p>
                                ...
                                comforts of their own home while on vacation or
                                business.
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                alternate house lights and collect newspapers at
                            ...
                            <ul>
                                <li>
                                    Private and personalized in-home care for up
                                    to 5 cats in the same household
                                </li>
