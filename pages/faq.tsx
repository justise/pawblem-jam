    ...
    <div id="container">
        ...
        <div id="content">
            <div className="banner-wrapper">
                <div className="banner" id="banner-faq"></div>
                ...
                <div className="yui3-g-r">
                        ...
                        <div className="summary">
                            ...
                            <p>
                                ...
                                <i style={{ display: 'none' }}>
                                    (English Hill, Education Hill, Trilogy,
                                    Redmond Ridge, Downtown)
                                </i>
                                <br />
                                Kirkland{' '}
                                <i style={{ display: 'none' }}>
                                    (Juanita, Moss Bay, Rose Hill, Totem Lake,
                                    Downtown)
                                </i>
                                <br />
                            </p>
                            ...
                            <p>
                                <h3>Please Note:</h3>
                                Due to the nature of our work, we aren't always
                                able to answer the phone, so please leave a
                                message. If you call on a Friday, we will return
                                your call the following business day.
                                <br />
                                <br />
                                Email is preferred for inquiries.
                            </p>
                        </div>
                    </div>
                    <div className="yui3-u-1-3">
                        <div className="summary">
                            <h2>&nbsp;</h2>
                            <img
                                src="/images/tiles/cat18.jpg"
                                alt="Cat Sitting in Redmond"
                            />
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid-wrapper">
                            ...
                            <p>
                                <ul>
                                    ...
                                    <li>
                                        <a href="#professional">
                                            Why should I hire a professional pet
                                            sitter?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#bonded">
                                            Is Pawblem Solved Licensed, Bonded
                                            and Insured?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#time">
                                            How much time do you spend at each
                                            visit with my pet?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#group">
                                            Will my dog be walked individually
                                            or in a group?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#who">
                                            Who will be walking my dog or taking
                                            care of my pets?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#aggressive">
                                            If my pet has been / is aggressive,
                                            can I still use your service?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#weather">
                                            Do you walk in any weather, all year
                                            long?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#keys">
                                            When do I give you my keys? How do I
                                            get them back from you?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#twokeys">
                                            Why do you need two (2) keys?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#payment">
                            ...
                            <p>
                                Our pet nannies are here to solve your pawblems
                                and provide peace of mind for pet parent and
                                pet.
                            </p>
                            ...
                            <h2 id="time">
                                How much time do you spend at each visit with my
                                pet?
                            </h2>
                            <p>
                                The standard visiting time is 30 minutes. We
                                believe this gives your pet just the right
                                amount of time to provide meals, exercise,
                                play-time, human interaction, attention and lots
                                of snuggles. As long as we have the
                                availability, we are definitely open to spending
                                more time with your pet; however, there will be
                                an additional charge. Please note; 30 minutes is
                                the minimum time we offer.{' '}
                            </p>

                            <h2 id="group">
                                Will my dog be walked individually or in a
                                group?
                            </h2>
                            <p>
                                We will walk up to three dogs in the same
                                household. Some dogs do not behave well with
                                others, so to ensure the safety of your dog(s)
                                and our sitters, we only provide individual,
                                private walks.{' '}
                            </p>

                            <h2 id="who">
                                Who will be walking my dog or taking care of my
                                pets?
                            </h2>
                            <p>
                            ...
                            <h2 id="aggressive">
                                If my pet has been / is aggressive, can I still
                                use your service?{' '}
                            </h2>
                            <p>
                                We take the safety of your pets and our sitters
                                very seriously. If our sitter feels
                                uncomfortable about a particular situation, we
                                reserve the right to discontinue or pass on the
                                service.
                            </p>
                            ...
                            <h2 id="keys">
                                When do I give you my keys? How do I get them
                                back from you?{' '}
                            </h2>
                            <p>
                            ...
                            <p>
                                Pets are generally visited between the hours of
                                9:00am to 6:00pm and visits are divided into
                                morning, midday and evening time periods. The
                                actual time your pet is visited depends on a
                                variety of logistical situations such as
                                location, traffic, construction and proximity to
                                other pet sitting clients. We will try to get as
                                close to a time that you request but cannot
                                guarantee it.
                            </p>

                            <h2 id="cancellationpolicy">
                                What is your cancellation policy?
                            </h2>
                            <p>
                                Your visits are very important to the Pawblem
                                Solved team and are reserved especially for you
                                and your pets. We understand that sometimes
                                schedule adjustments are necessary; therefore,
                                we respectfully request at least 24 hours notice
                                for cancellations.
                            </p>
                            <p>
                                Please understand that when you cancel your
                                visit without giving enough notice, we miss the
                                opportunity to fill that time.
                            </p>
                            <p>
                                Less than 24 hour notice will result in a charge
                                equal to 50% of the reserved service amount.
                            </p>
